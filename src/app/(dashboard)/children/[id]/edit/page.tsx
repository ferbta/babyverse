...
const childSchema = z.object({
    ...
    birthWeight: z.string().optional().nullable(),
    birthHeight: z.string().optional().nullable(),
    birthCondition: z.string().optional().nullable(),
})
...
export default function EditChildPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const bloodType = watch('bloodType') || undefined
    const birthCondition = watch('birthCondition') || undefined
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    reset({
                        ...
                        birthCondition: data.birthCondition,
                    })
                } else {
                    setError('Không thể tải thông tin bé')
                }
            } catch (error) {
                ...
                <CardHeader>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <CardDescription>Cập nhật thông tin của bé</CardDescription>
                        </div>
                    </div>
                </CardHeader>
                <CardContent>
